...
bunch_ene = Bunch()
bunch_ene.readBunch("bunch_in_SCL.dat")
bunch_test.getSyncParticle().time(0.0)
KE = bunch_ene.getSyncParticle().kinEnergy()
bunch_ene.getSyncParticle().kinEnergy(KE * 1.001)
#bunch_test.getSyncParticle().kinEnergy(KE * 1.0001)
bunch_test.dumpBunch("bunch_test5.dat")

accLattice_SCL.trackDesignBunch(bunch_ene)
accLattice_SCL.trackBunch(bunch_test)

print(bunch_test.getSyncParticle().time(), bunch_test.getSyncParticle().beta())
bunch_test.dumpBunch("bunch_test4.dat")
